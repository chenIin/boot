...
public class TestDataChild11 extends DataEntity<TestDataChild11> {
	...
	private TestDataMainForm1 testDataMain;		// 业务主表ID 父类
	...
	public TestDataChild11(TestDataMainForm1 testDataMain){
	...
	public TestDataMainForm1 getTestDataMain() {
		return testDataMain;
	}

	public void setTestDataMain(TestDataMainForm1 testDataMain) {
		this.testDataMain = testDataMain;
	}
