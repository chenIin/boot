...
public class TestDataChild21 extends DataEntity<TestDataChild21> {
	...
	private TestDataMainForm2 testDataMain;		// 业务主表ID 父类
	...
	public TestDataChild21(TestDataMainForm2 testDataMain){
	...
	@ExcelField(title="文件", align=2, sort=6)
	...
	public TestDataMainForm2 getTestDataMain() {
		return testDataMain;
	}

	public void setTestDataMain(TestDataMainForm2 testDataMain) {
		this.testDataMain = testDataMain;
	}
