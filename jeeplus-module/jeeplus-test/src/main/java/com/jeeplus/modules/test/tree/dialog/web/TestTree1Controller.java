...
public class TestTree1Controller extends BaseController {
	...
	public List<TestTree1> data(TestTree1 testTree1) {
		return testTree1Service.findList(testTree1);
	}
	...
	public String form(@PathVariable String mode, TestTree1 testTree1, Model model) {
