					...
					"items": function (node) {
						...
						tmp.create = {
							...
							"action": function (data) {
								...
								jp.openSaveDialog('添加下级车系', '${ctx}/test/treetable/dialog/carKind1/form/edit?parent.id=' + obj.id + "&parent.name=" + obj.text, '800px', '500px');
							}
						};
						tmp.remove = {
							"label": "删除车系",
						...
						tmp.ccp = {
							...
							"action": function (data) {
								...
								jp.openSaveDialog('编辑车系', '${ctx}/test/treetable/dialog/carKind1/form/edit?id=' + obj.id, '800px', '500px');
							}
						}
						return tmp;
					}
