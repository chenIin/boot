...
public class FileKit {
    ...
    public static  String getFileDir(String fileUrl){
        return  fileUrl.replace(Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL , JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL).replace("\\","/");
    }
    ...
    public static String getShareBaseUrl(){
        ...
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL +  "/共享文档/";
    }
    ...
    public static String getMyDocDir(){
        SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
        String dir = JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL + principal + "/我的文档/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    /**
    ...
    public static String getMyDocUrl(){
        SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL + principal + "/我的文档/";
    }
    ...
    public static String getAttachmentDir(){
        SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
        String dir = JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL + principal + "/程序附件/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    ...
    public static String getAttachmentUrl(){
        ...
        SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL + principal + "/程序附件/";
    }
    ...
    public static String transDirToUrl(String dir){
        return   Servlets.getRequest().getContextPath()+"/" + dir.substring(JeePlusProperites.newInstance().getUserfilesBaseDir().length());
    }
