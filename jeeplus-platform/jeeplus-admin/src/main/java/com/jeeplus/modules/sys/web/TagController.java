...
public class TagController extends BaseController {
	...
	public String gridselect(String url, String fieldLabels, String fieldKeys, String searchLabels, String searchKeys, boolean isMultiSelected, HttpServletRequest request, HttpServletResponse response, Model model) {
		try {
	...
	public String fileUpload(String fileValues, String readonly, String uploadPath, String type, String fileNumLimit, String fileSizeLimit, String allowedExtensions, Model model) {
		...
		for(String value: fieldValuesArra){
			fileIds = fileIds + FileKit.getFileDir(value) + "|";
			fileSizes = fileSizes + FileKit.getFileSize(FileKit.getFileDir(value))+ "|";
		}
