...
//
    ...
    public static boolean isStaticFile(String uri){
		if (jeePlusProperites.getWebStaticFile() == null){
			try {
...
//			return true;
//		}
		if (StringUtils.endsWithAny(uri, jeePlusProperites.getWebStaticFile()) && !StringUtils.endsWithAny(uri, jeePlusProperites.getUrlSuffix())
				&& !StringUtils.endsWithAny(uri, ".jsp") && !StringUtils.endsWithAny(uri, ".java")){
			return true;
		}
		return false;
