	...
	$('#procInsTable').bootstrapTable({
		  ...
		  //请求方法
			...
			,{
			   ...
			   formatter:function (value, row, index) {
		        	if(value == null){
						return "<font class='badge badge-custom'>正常结束</font>";
					}else if(value=="用户撤销"){
                        return "<font class='badge badge-pink'>用户撤销</font>";
					}else {
                        return "<font  class='badge badge-danger'>[流程作废] 原因："+value+"</font>";
					}
					   ...
					   formatter: function operateFormatter(value, row, index) {
						   return [
                               ...
                               '<a class=" btn btn-xs btn-success waves-effect waves-light m-r-5" href="${ctx}/act/task/formDetail?'+'&procInsId='+row.processInstanceId+'&procDefId='+row.processDefinitionId+'">详情</a>',
                               '<a class="del  btn btn-xs btn-danger waves-effect waves-light m-r-" href="#" >删除</a>',
						   ].join('');
					   }
                   }
		     ]
